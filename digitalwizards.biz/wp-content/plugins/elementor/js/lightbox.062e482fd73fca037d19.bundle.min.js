...
(self.webpackChunkelementor = self.webpackChunkelementor || []).push([[723], {
    5626: (e,t,s)=>{
        "use strict";
        var i = s(3203);
    ...
    4508: (e,t,s)=>{
        ...
        class IconsManager {
            ...
            createSvgNode(e, t) {
                ...
                return Object.keys(s).map((e=>n[e] = s[e])),
            ...
            createSvgSymbolsContainer() {
                if (!IconsManager.symbolsContainer) {
                    ...
                    IconsManager.symbolsContainer || (IconsManager.symbolsContainer = this.createSvgNode("svg", {
                        attrs: {
                            style: "display: none;",
                            class: e
                        }
        ...
        t.default = IconsManager,
            (0,
                n.default)(IconsManager, "symbolsContainer", void 0),
            (0,
                n.default)(IconsManager, "iconsUsageList", [])
    }
    ,
    3896: (e,t,s)=>{
        "use strict";
        ...
        e.exports = elementorModules.ViewModule.extend({
            ...
            showModal(e) {
                ...
                const n = t.getModal();
                switch (n.setID(t.getSettings("modalOptions.id")),
                    n.onShow = function() {
                        DialogsManager.getWidgetType("lightbox").prototype.onShow.apply(n, arguments),
                            t.setEntranceAnimation()
                    }
                    ,
                    n.onHide = function() {
                        DialogsManager.getWidgetType("lightbox").prototype.onHide.apply(n, arguments),
            ...
            createLightbox(e) {
                let t = {};
                if (e.dataset.elementorLightbox && (t = JSON.parse(e.dataset.elementorLightbox)),
            ...
            setHTMLContent(e) {
                window.elementorCommon && elementorDevTools.deprecation.deprecated("elementorFrontend.utils.lightbox.setHTMLContent", "3.1.4"),
            ...
            setVideoContent(e) {
                ...
                if ("hosted" === e.videoType) {
                    ...
                    if (-1 !== e.url.indexOf("vimeo.com"))
                        ...
                        if (!e.url.match(/^(?:https?:\/\/)?(?:www\.)?(?:m\.)?(?:youtu\.be\/|youtube\.com|youtube-nocookie\.com)/))
                            return;
                ...
                l.onHide = function() {
                    a(),
                        this.$buttons = jQuery(),
                        this.focusedButton = null,
                        l.getElements("message").removeClass("elementor-fit-aspect-ratio")
                }
            },
            getShareLinks() {
            ...
            createShareLink(e, t) {
                ...
                const i = {};
                return "pinterest" === e ? i.image = encodeURIComponent(t) : i.url = encodeURIComponent(location.href.replace(/#.*/, "") + s),
            ...
            getSlideshowHeader() {
                const {i18n: e} = elementorFrontend.config
                    ...
                    , l = "yes" === elementorFrontend.getKitSettings("lightbox_enable_share")
                ...
                if (s || i || o || l) {
                    if (d.$header = t("<header>", {
                        ...
                        i.on("click", (e=>{
                            ...
                            d.$iconShare.add(d.$shareMenu).on("click", this.toggleShareMenu),
                    ...
                    if (o) {
                        ...
                        this.isFontIconSvgExperiment || (l.class = r.iconZoomIn),
                            d.$iconZoom = t(s).attr(l).on("click", this.toggleZoomMode),
                            i.push(d.$iconZoom),
                        this.isFontIconSvgExperiment && (d.$iconZoomOut = t(n.zoomOutBold.element).attr(o).addClass(a.hidden).on("click", this.toggleZoomMode),
                    ...
                    if (i) {
                        ...
                        this.isFontIconSvgExperiment || (l.class = r.iconExpand),
                            d.$iconExpand = t(s).append(t("<span>"), t("<span>")).attr(l).on("click", this.toggleFullscreen),
                            i.push(d.$iconExpand),
                        this.isFontIconSvgExperiment && (d.$iconMinimize = t(n.frameMinimize.element).attr(o).addClass(a.hidden).on("click", this.toggleFullscreen),
            ...
            activateFullscreen() {
                const e = this.getSettings("classes");
                i.default.request(this.elements.$container.parents(".dialog-widget")[0]),
                    this.isFontIconSvgExperiment ? (this.elements.$iconExpand.addClass(e.hidden).attr("aria-checked", "false"),
                        this.elements.$iconMinimize.removeClass(e.hidden).attr("aria-checked", "true")) : this.elements.$iconExpand.removeClass(e.slideshow.iconExpand).addClass(e.slideshow.iconShrink).attr("aria-checked", "true"),
                    this.elements.$container.addClass(e.slideshow.fullscreenMode)
            },
            deactivateFullscreen() {
                const e = this.getSettings("classes");
                i.default.exit(),
                    this.isFontIconSvgExperiment ? (this.elements.$iconExpand.removeClass(e.hidden).attr("aria-checked", "true"),
                        this.elements.$iconMinimize.addClass(e.hidden).attr("aria-checked", "false")) : this.elements.$iconExpand.removeClass(e.slideshow.iconShrink).addClass(e.slideshow.iconExpand).attr("aria-checked", "false"),
            ...
            activateZoom() {
                ...
                e.zoom.in(),
                    ...
                    this.isFontIconSvgExperiment ? (t.$iconZoom.addClass(s.hidden).attr("aria-checked", "false"),
                        t.$iconZoomOut.removeClass(s.hidden).attr("aria-checked", "true")) : t.$iconZoom.removeClass(s.slideshow.iconZoomIn).addClass(s.slideshow.iconZoomOut)
            },
            deactivateZoom() {
                const e = this.swiper
                    , t = this.elements
                ...
                e.zoom.out(),
                    ...
                    this.isFontIconSvgExperiment ? (t.$iconZoom.removeClass(s.hidden).attr("aria-checked", "true"),
                        t.$iconZoomOut.addClass(s.hidden).attr("aria-checked", "false")) : t.$iconZoom.removeClass(s.slideshow.iconZoomOut).addClass(s.slideshow.iconZoomIn)
            },
            getSlideshowFooter() {
                const e = jQuery
            ...
            setSlideshowContent(e) {
                ...
                if (e.slides.forEach((e=>{
                        ...
                        if (e.video) {
                            ...
                            e.title && (n["data-title"] = e.title,
                                n.alt = e.title),
                            e.description && (n["data-description"] = e.description,
                                n.alt += " - " + e.description);
                            const l = s("<img>", n);
                            t.append([l, i]),
                                o.append(t)
                        }
                        e.hash && o.attr("e-action-hash", e.hash),
                            h.append(o)
                    }
                )),
                ...
                if (9 === e.which) {
                    ...
                    t.each((e=>{
                        ...
                        e.shiftKey ? i && (e.preventDefault(),
                            t.last().trigger("focus")) : !n && s || (e.preventDefault(),
                            t.first().trigger("focus"))
                }
            },
            ...
            playSlideVideo() {
                ...
                i.append(n),
                    e.append(i),
                    -1 !== t.indexOf("vimeo.com") ? (l = "vimeo",
                        a = elementorFrontend.utils.vimeo) : t.match(/^(?:https?:\/\/)?(?:www\.)?(?:m\.)?(?:youtu\.be\/|youtube\.com)/) && (l = "youtube",
                        a = elementorFrontend.utils.youtube);
