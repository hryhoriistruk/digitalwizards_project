...
!function(p, t) {
    ...
    var y = {
        ...
        createWidgetType: function(t, e, n) {
            ...
            return o.types = o.types.concat([t]),
                p.extend(o, e),
    ...
    y.Instance = function() {
        ...
        y.Widget = function(n) {
            function e(t, e) {
                ...
                if (p.isFunction(n))
                    ...
                    if (!t[n])
                        throw "Reference Error: The effect " + n + " not found";
                    t[n].apply(t, e)
                }
            }
            function i(t) {
                if (!f(t)) {
                    if (u.hide.onClick) {
                        if (p(t.target).closest(u.selectors.preventClose).length)
                            return
                    } else if (t.target !== this)
                        return;
                    c.hide()
                }
            }
            ...
            function s(t, e) {
                t = p.extend(!0, {}, t.getSettings()),
                    ...
                    p.each(u, function(t) {
                        t = t.match(/^on([A-Z].*)/);
                        t && (t = t[1].charAt(0).toLowerCase() + t[1].slice(1),
                            c.on(t, this))
                    })
            }
            function r(t) {
            ...
            function t() {
                ...
                d.iframe && t.push(jQuery(d.iframe[0].contentWindow)),
                    t.forEach(function(t) {
                        ...
                        u.hide.onOutsideContextMenu && t[0].removeEventListener("contextmenu", o, !0),
            ...
            this.addElement = function(t, e, n) {
                ...
                this.hide = function() {
                    if (c.isVisible())
                        return clearTimeout(l),
                            e("hide", arguments),
                            t(),
                        u.preventScroll && c.getElements("body").removeClass(u.classes.preventScroll),
                            c.trigger("hide"),
                            c
                }
                ,
                this.init = function(t, e) {
                    ...
                    var n;
                    return n = h.concat(c.getClosureMethods()),
                        p.each(n, function() {
                            var t = c[this];
                            c[this] = function() {
                                t.apply(c, arguments)
                ...
                this.off = function(t, e) {
                    ...
                    if (!e)
                        return delete a[t],
                            c;
                    e = a[t].indexOf(e);
                    return -1 !== e && a[t].splice(e, 1),
                        c
                }
                ,
                this.refreshPosition = function() {
                    var t, e, n, i, o, s, r;
                    u.position.enable && (t = p.extend({}, u.position),
                    d[t.of] && (t.of = d[t.of]),
                    t.of || (t.of = window),
                    u.iframe && (e = t).my && (n = /([+-]\d+)?$/,
                        i = d.iframe.offset(),
                        ...
                        s = e.my.split(" "),
                        r = [],
                    1 === s.length && (/left|right/.test(s[0]) ? s.push("center") : s.unshift("center")),
                        s.forEach(function(t, e) {
                            t = t.replace(n, function(t) {
                                return t = +t || 0,
                                    t = 0 <= (t += e ? i.top - o.scrollY : i.left - o.scrollX) ? "+" + t : t
                            });
                            r.push(t)
                        }),
                        e.my = r.join(" ")),
                ...
                this.setID = function(t) {
                    return d.widget.attr("id", t),
                        c
                }
                ,
                this.setHeaderMessage = function(t) {
                    return c.getElements("header").html(t),
                        c
                }
                ,
                this.setMessage = function(t) {
                    return d.message.html(t),
                        c
                }
                ,
                this.setSettings = function(t, e) {
                    return jQuery.isPlainObject(e) ? p.extend(!0, u[t], e) : u[t] = e,
                        c
                }
                ,
                this.show = function() {
                    ...
                    d.iframe && t.push(jQuery(d.iframe[0].contentWindow)),
                        t.forEach(function(t) {
                            ...
                            u.hide.onOutsideContextMenu && t[0].addEventListener("contextmenu", o, !0),
                            u.position.autoRefresh && t.on("resize", c.refreshPosition)
                        }),
                    (u.hide.onClick || u.hide.onBackgroundClick) && d.widget.on("click", i),
                    u.preventScroll && c.getElements("body").addClass(u.classes.preventScroll),
                        c.trigger("show"),
                        c
                }
                ,
        ...
        y.addWidgetType("buttons", {
            ...
            activeKeyDown: function(t) {
                var e, n;
                !this.focusedButton || 9 === t.which && (t.preventDefault(),
                    e = this.focusedButton.index(),
                    t.shiftKey ? (n = e - 1) < 0 && (n = this.buttons.length - 1) : (n = e + 1) >= this.buttons.length && (n = 0),
